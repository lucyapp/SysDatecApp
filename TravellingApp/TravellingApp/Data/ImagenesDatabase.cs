...
namespace ScanApp.Data
{
    class ImagenesDatabase
    {
        ...
        {
            Database = new SQLiteAsyncConnection(Constants.DatabasePathImagenes, Constants.Flags);
        }
        ...
        {
            return Database.QueryAsync<ImagenesModel>("SELECT * FROM [ImagenesModel] WHERE [ImageSource] = ''");
        }
