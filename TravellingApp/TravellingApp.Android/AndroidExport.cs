...
using ScanApp.Helper;
using Plugin.CurrentActivity;
using System;
using System.IO;
using Xamarin.Essentials;

[assembly: Xamarin.Forms.Dependency(typeof(ScanApp.Droid.AndroidExport))]
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        private bool WriteAPI29AndAbove(string contents, string filename)
        {
            ...
            values.Put(Android.Provider.MediaStore.MediaColumns.Title, filename);
            values.Put(Android.Provider.MediaStore.MediaColumns.MimeType, "text/plain");
